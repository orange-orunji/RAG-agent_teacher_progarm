...
for expalate in examples_data:
  message.append({'role':"user","content":expalate["content"]})
  message.append({'role':"assistant","content":json.dumps(expalate["answers"],ensure_ascii=False)})
