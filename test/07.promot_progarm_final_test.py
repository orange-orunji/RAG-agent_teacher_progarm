...
"""
[
    {"role": "system", "content": f"你帮我完成文本匹配，我给你2个句子，被[]包围，判断它们是否匹配，回答是或不是，请参考如下示例："},
...
message = [ {"role": "system", "content": f"你帮我完成文本匹配，我给你2个句子，被[]包围，判断它们是否匹配，回答是或不是，请参考如下示例："}]
...
for question in questions:
  c = client.chat.completions.create(
    model="qwen3-max",
    messages=message+[{"role": "user", "content": f"按照上述示例，回答这2个句子的情况。句子1：[{question[0]}]，句子2：[{question[1]}]"}]
  )
